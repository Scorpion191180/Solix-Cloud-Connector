...
class DashboardSchematicTests(unittest.TestCase):
    def test_schematic_contains_every_energy_component(self) -> None:
        ...
        self.assertIn("style.css?v=20260805-46", dashboard)
        self.assertIn("house.js?v=20260805-46", dashboard)
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn("pv: new THREE.Vector3(PERGOLA_CENTER.x, 3.28, PERGOLA_CENTER.z)", script)
        ...
        self.assertIn("[8.02, pvUnderPanelY(8.02), -8.56]", script)
