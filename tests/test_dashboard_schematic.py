...
class DashboardSchematicTests(unittest.TestCase):
    def test_schematic_contains_every_energy_component(self) -> None:
        ...
        self.assertIn("style.css?v=20260803-10", dashboard)
        self.assertIn("house.js?v=20260803-10", dashboard)
        self.assertIn("app.js?v=20260803-10", dashboard)
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn('createFrontWoodDoor(house, [3.30, 1.35, -3.32]', script)
        self.assertIn('createDoor(house, [3.30, 1.35, -4.43]', script)
        ...
        self.assertIn("[4.90, 0.42, -0.55, -2.12, -5.20]", script)
        self.assertIn("[3.88, 2.82, set.z]", script)
