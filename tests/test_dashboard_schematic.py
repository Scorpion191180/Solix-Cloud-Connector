...
class DashboardSchematicTests(unittest.TestCase):
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn("grid: new THREE.Vector3(GRID_BOX_POSITION.x, 1.72, GRID_BOX_POSITION.z)", script)
        self.assertIn("audi: new THREE.Vector3(5.00, 1.52, 1.00)", script)
        ...
        self.assertIn("const cutawayVisible = false", script)
        self.assertNotIn('detailLevel === "interior"', script)
        ...
        self.assertIn('"--string-label-angle", "0deg"', script)
