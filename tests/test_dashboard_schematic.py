...
class DashboardSchematicTests(unittest.TestCase):
    def test_schematic_contains_every_energy_component(self) -> None:
        ...
        self.assertIn("style.css?v=20260804-21", dashboard)
        self.assertIn("house.js?v=20260804-21", dashboard)
        self.assertIn("app.js?v=20260804-21", dashboard)
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn("[4.58, 1.38, 5.72]", script)
        self.assertIn("[5.14, 1.86, -3.18]", script)
        self.assertIn("Solarbank 4 E5000 Pro nach der offiziellen Produktansicht", script)
        self.assertIn("panel.anchor.set((4.01 + panel.cableX) * 0.5", script)
