...
class DashboardSchematicTests(unittest.TestCase):
    def test_schematic_contains_every_energy_component(self) -> None:
        ...
        self.assertIn("style.css?v=20260805-42", dashboard)
        self.assertIn("house.js?v=20260805-42", dashboard)
        self.assertIn("app.js?v=20260805-42", dashboard)
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn("[3.40, 2.28, -6.18]", script)
        self.assertIn("[3.40, 4.70, -1.93]", script)
        self.assertIn("[3.62, 2.52, -1.10]", script)
