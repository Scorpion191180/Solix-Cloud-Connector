...
class DashboardSchematicTests(unittest.TestCase):
    def test_schematic_contains_every_energy_component(self) -> None:
        ...
        self.assertIn("style.css?v=20260805-49", dashboard)
        self.assertIn("house.js?v=20260805-49", dashboard)
    ...
    def test_virtual_house_is_touch_enabled_and_uses_live_data(self) -> None:
        ...
        self.assertIn("const waveColor = discharging ? 0xfdba74 : 0x86efac", script)
        ...
        self.assertIn("const edgeMarginX = Math.min(58, rect.width * 0.22)", script)
        ...
        self.assertIn("[3.62, 2.38, -1.10]", script)
        ...
        self.assertIn("Math.max(0, state.zoom - 1) * 0.28", script)
